...
//! Otherwise returns None, so the calling utility would assume default
//! behavior.
//!
...
/// '200112' for POSIX 1003.1-2001, which is the minimum version for Traditional
/// mode
...
/// Returns the value of the `_POSIX2_VERSION` environment variable if it is
/// defined
