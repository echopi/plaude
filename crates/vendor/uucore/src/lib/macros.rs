...
///
/// Wraps around [`crate::show!`] and takes a [`crate::error::UResult`] instead
/// of a [`crate::error::UError`] type. This macro invokes [`crate::show!`] if
/// the [`crate::error::UResult`] is an `Err`-variant. This can be invoked
/// directly on the result of a function call, like in the `install` utility:
///
/// ```ignore
