...
/// A struct that holds a slice of format arguments and provides methods to
/// access them
...
impl<'a> FormatArguments<'a> {
	...
	pub fn new(args: &'a [FormatArgument]) -> Self {
		Self { args, next_arg_position: 0, highest_arg_position: None, current_offset: 0 }
	}
